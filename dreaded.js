...
"🤬",
        "🗿",	
"⭓𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐁𝐞𝐥𝐭𝐚𝐡! 😬"
]
let { key } = await client.sendMessage(from, {text: '𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐁𝐞𝐥𝐭𝐚𝐡! 😬...'})
...
┃𓅓│ 𝐕𝐞𝐫𝐬𝐢𝐨𝐧: ©²-²-⁴
┃𓅓│ 𝗦𝗽𝗲𝗲𝗱 :  *${dreadedspeed.toFixed(4)}* 
┃𓅓│ *prefix* : ${prefix}
┃𓅓│▎▍▌▌▉▏▎▌▉▐▏▌
┃𓅓│▎▍▌▌▉▏▎▌▉▐▏▌
...
┃𓅓│Unblock
┃𓅓│Setvar
┬✯│MAKING WHATSAPP A BETTER PLACE┃𓅓
│╰─────────────────❍
╰══════════════════⊷❍
...
case "speed": case "test":
              ...
              client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dcce2ddee6cc7597c859a.jpg' }, caption:`BOT CURRENTLY ACTIVE!\n\n𝐒𝐏𝐄𝐄𝐃:𓅓𝙱𝙴𝙻𝚃𝙰𝙷 𝙿𝙾𝙽𝙶...! ${dreadedspeed.toFixed(4)} Ms`}); 
 break; 
...
case "ping": case "speed": { 
         m.reply (`𓅓𝙱𝙴𝙻𝚃𝙰𝙷 𝙿𝙾𝙽𝙶...! ${dreadedspeed.toFixed(4)} MS`); 
         } 
 break; 
  
 case "runtime": case "uptime": { 
                 m.reply (` 𝑼𝑷𝑻𝑰𝑴𝑬 𝑶𝑭 𝑩𝑬𝑳𝑻𝑨𝑯-𝑻𝑬𝑪𝑯 𝑰𝑺 : ${runtime(process.uptime())} `) 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dcce2ddee6cc7597c859a.jpg' }, caption: `Hello ${m.pushName},\n\n𝐁𝐞𝐥𝐭𝐚𝐡-𝐌𝐃 is alive since\n${runtime(process.uptime())}`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
